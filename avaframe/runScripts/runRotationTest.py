...
energyLineTestCfg = cfgUtils.getModuleConfig(energyLineTest, avalancheDir, toPrint=False,
...
AIMECCfg = cfgUtils.getModuleConfig(ana3AIMEC, avalancheDir, toPrint=False,
